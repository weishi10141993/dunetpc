#ifndef CHEATRECOTRACKSELECTOR_H_SEEN
#define CHEATRECOTRACKSELECTOR_H_SEEN
//STL
#include <iostream>
#include <limits>
//ROOT
...
namespace FDSelectionTools{
  class CheatRecoTrackSelector : public RecoTrackSelector{
    public:
      explicit CheatRecoTrackSelector(fhicl::ParameterSet const& ps);
...
DEFINE_ART_CLASS_TOOL(FDSelectionTools::CheatRecoTrackSelector)
#endif
